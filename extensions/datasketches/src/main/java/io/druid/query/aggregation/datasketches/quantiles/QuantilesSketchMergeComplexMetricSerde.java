...
public class QuantilesSketchMergeComplexMetricSerde extends ComplexMetricSerde
{
  ...
  public ComplexMetricExtractor getExtractor()
  {
    return new ComplexMetricExtractor()
    {
      ...
      public Object extractValue(InputRow inputRow, String metricName)
      {
        ...
        if (object == null || object instanceof QuantilesSketch) {
          return object;
        }
  ...
  {
    GenericIndexed<QuantilesSketch> ge = GenericIndexed.read(buffer, strategy);
    builder.setComplexColumn(new ComplexColumnPartSupplier(getTypeName(), ge));
  }

  @Override
  public ObjectStrategy<QuantilesSketch> getObjectStrategy()
  {
    return strategy;
  }
