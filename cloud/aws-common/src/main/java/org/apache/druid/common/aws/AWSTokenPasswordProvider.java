...
public class AWSTokenPasswordProvider implements PasswordProvider
{
  private static final Logger LOGGER = new Logger(AWSTokenPasswordProvider.class);
  ...
  @JsonCreator
  public AWSTokenPasswordProvider(
