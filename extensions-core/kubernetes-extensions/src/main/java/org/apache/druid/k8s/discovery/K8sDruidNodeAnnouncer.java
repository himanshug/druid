...
public class K8sDruidNodeAnnouncer implements DruidNodeAnnouncer
{
  ...
  private Map<String, String> createPatchObj(String op, String path, String value)
  {
    if (value == null) {
  ...
  {
    return StringUtils.format("/metadata/labels/%s", label);
  }

  private String getPodDefAnnocationPath(String annotation)
  {
    return StringUtils.format("/metadata/annotations/%s", annotation);
  }
