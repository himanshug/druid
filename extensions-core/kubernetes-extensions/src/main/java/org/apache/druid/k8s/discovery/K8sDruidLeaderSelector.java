...
public class K8sDruidLeaderSelector implements DruidLeaderSelector
{
  ...
  public K8sDruidLeaderSelector(@Self DruidNode self, String lockResourceName, PodInfo podInfo, K8sDiscoveryConfig discoveryConfig, K8sLeaderElectorFactory k8sLeaderElectorFactory)
  {
    ...
    leaderElector.run(
        () -> {
          try {
            ...
            leader = false;
            //TODO: write comment why this is OK.
            System.exit(1);
          }
        },
        () -> {
  ...
  // Document the interface that getCurrentLeader() is expected to work even without registering the listener.
  @Nullable
  @Override
