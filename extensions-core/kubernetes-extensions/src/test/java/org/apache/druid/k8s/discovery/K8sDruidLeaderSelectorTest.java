...
public class K8sDruidLeaderSelectorTest
{
  ...
  private final K8sDiscoveryConfig discoveryConfig = new K8sDiscoveryConfig("druid-cluster", null, null, Duration.millis(10_000), Duration
      .millis(7_000), Duration.millis(3_000));
