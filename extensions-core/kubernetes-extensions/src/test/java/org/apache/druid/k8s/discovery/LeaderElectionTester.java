...
/**
 * TODO:
 * - test GC at leader, another candidate becomes leader and then old leader steps down.
 * - test normal jvm exit works to ensure no non-daemon threads are hanging around.
 */
public class LeaderElectionTester
{
  ...
  private final PodInfo podInfo = new PodInfo("druid-cbs-druid-routers-0", "cja-dev");

  private final K8sDiscoveryConfig discoveryConfig = new K8sDiscoveryConfig("druid–cluster", null, null, Duration.ofMillis(10_000), Duration.ofMillis(7_000), Duration.ofMillis(3_000));

  private final ApiClient k8sApiClient;

  private final String lockResourceName = "druid-leader-election";

  public LeaderElectionTester() throws Exception
  {
  ...
  {
    K8sDruidLeaderSelector leaderSelector = new K8sDruidLeaderSelector(testNode1.getDruidNode(), lockResourceName, podInfo, discoveryConfig, new DefaultK8sLeaderElectorFactory(k8sApiClient, discoveryConfig));
  ...
  @Test(timeout = 60000L)
  public void test_leaderCandidate_died() throws Exception
  {
    K8sDruidLeaderSelector leaderSelector = new K8sDruidLeaderSelector(testNode1.getDruidNode(), lockResourceName, podInfo, discoveryConfig, new DefaultK8sLeaderElectorFactory(k8sApiClient, discoveryConfig));
    ...
    leaderSelector = new K8sDruidLeaderSelector(testNode2.getDruidNode(), lockResourceName, podInfo, discoveryConfig, new DefaultK8sLeaderElectorFactory(k8sApiClient, discoveryConfig));
